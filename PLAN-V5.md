...
- **Recalibrar tira el músculo proyectado también en los perfiles SIN báscula (visto en E11) — DECIDIDO 8 ago 2026, tarea de v2:** el usuario eligió **arreglarlo para TODOS los perfiles** (hoy solo los de báscula conservan la ganancia; un perfil `estimated` pierde 1,67 kg en el día 300 del caso real al re-estimar con la proporción de población). Contrapartida aceptada: **cambia la duración de los planes YA creados** la próxima vez que se recalibren. No implementado aún; entra en la planificación de la v2.
