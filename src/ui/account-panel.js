...
import { ERROR_KEYS, claveDeError } from './account-errors.js';
...
/**
 * Se reexporta porque los tests y la vista de Fotos lo consultan, y porque
 * partir la lista en dos sería tener dos vocabularios de error.
 */
export { ERROR_KEYS };
