...
const CACHE_VERSION = 'tl-07d11b715f45';
...
const PRECACHE = [
    ...
    'src/core/demo.js',
    'src/data/demo-profile.js',
    'src/data/import-weights.js',
    ...
    'src/data/photos-remap.js',
    'src/data/profile-remap.js',
    'src/data/profiles.js',
    'src/data/schema.js',
    'src/data/settings.js',
    'src/data/sync-policy.js',
    'src/data/sync.js',
    'src/data/photos-remote.js',
    'src/data/storage.js',
    'src/data/version.js',
    ...
    'src/ui/pwa.js',
    'src/ui/sync-loop.js',
    'src/ui/image-compress.js',
    'src/ui/account-errors.js',
    'src/ui/reminder.js',
