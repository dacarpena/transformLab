...
test('4· db.js exporta exactamente lo previsto, y lo global está declarado', () => {
    ...
    const GLOBALES = {
        ...
        findFederated: 'convierte un `sub` de Google en un usuario: ídem, y por eso es global',
        createAccountFederated: 'crea la cuenta cuya primera credencial es una identidad externa',
        touchFederated: 'anota que una identidad externa se ha usado; el usuario sale de ella, no de una sesión',
